"""Focused tests for the standalone Turtle batch chart."""
...
LAB_TOOLS = Path(__file__).resolve().parents[1]
sys.path.insert(0, str(LAB_TOOLS))

from batch_chart import (  # noqa: E402
    BatchChartError,
    create_chart,
    read_chart,
    update_chart,
...
class BatchChartTests(unittest.TestCase):
    ...
    def test_persists_across_separate_cli_executions(self):
        module = LAB_TOOLS / "batch_chart.py"
        commands = [
